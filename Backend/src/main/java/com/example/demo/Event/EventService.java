...
public class EventService {
    ...
    public void insertTestData() {
        ...
        List<Event> events = List.of(
            ...
            new Event(null, "CGV 포인트 페이백 행사", "2025.05.10 ~ 2025.05.19", "추천", List.of("/images/event3.jpg")),
            new Event(null, "씨네21 X 메가박스 컬래버 이벤트", "2025.05.10 ~ 2025.05.19", "추천", List.of("/images/event4.jpg")),

            new Event(null, "빼앗긴 거리", "2025.05.24 ~ 2025.06.08", "메가Pick", List.of("/images/megapick1.jpg", "/images/megapick1.jpg")),
